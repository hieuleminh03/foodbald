...
class FParticle  extends flash.display.Sprite {
	...
	public static var LIMIT = 9999;
	public static var ALL : Array<FParticle> = [];
	...
	inline function get_bounce() return bounceMul;
	inline function set_bounce(v) return bounceMul = v;
